...
const GestionarTareaTrabajadores = () => {
  ...
  useEffect(() => {
    axios
      .get(`https://fumifortebe-gxhg.onrender.com/solicitudes/${idSolicitudServicio}`, {
  ...
  useEffect(() => {
    axios
      .get("https://fumifortebe-gxhg.onrender.com/gerente/trabajadores", {
        withCredentials: true,
      })
      .then((res) => {
  ...
  const handleCrearSesion = async () => {
    ...
    try {
      ...
      const resSesion = await axios.post(
        "https://fumifortebe-gxhg.onrender.com/sesion/crear",
        sesionData,
        { withCredentials: true }
      );
      ...
      setIdSesionCreada(idSesion);
        ...
        await axios.post("https://fumifortebe-gxhg.onrender.com/participa/crear", p, {
            withCredentials: true,
        });
        }
