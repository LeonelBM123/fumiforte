...
function GestionarInventario() {
  ...
  const obtenerProductos = async () => {
    try {
      ...
      const response = await axios.get("https://fumifortebe.onrender.com/gerente/productos", {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post("https://fumifortebe.onrender.com/nuevo_producto", cleanedForm, {
        withCredentials: true,
  ...
  const confirmarEliminarProducto = async () => {
    ...
    try {
      await axios.delete(`https://fumifortebe.onrender.com/productos/${productoAEliminar.idProducto}`, {
        withCredentials: true,
      });
  ...
  const handleConfirmarEdicion = async () => {
    ...
    try {
      const response = await axios.put(
        `https://fumifortebe.onrender.com/productos/${cleanedForm.idProducto}`,
        cleanedForm,
        {
          withCredentials: true,
          headers: {
