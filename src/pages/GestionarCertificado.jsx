...
function GestionarCertificado() {
  ...
  const obtenerCertificados = async () => {
    try {
      setLoading(true);
      const response = await fetch("https://fumifortebe.onrender.com/gerente/listar_certificados", {
        method: "GET",
        credentials: "include",
        headers: {
  ...
  const handleConfirmarEdicion = async () => {
    try {
      await axios.put(
        `https://fumifortebe.onrender.com/gerente/actualizar_certificado/${form.idCertificado}`,
        {
  ...
  const confirmarEliminarCertificado = async () => {
    try {
      await axios.delete(
        `https://fumifortebe.onrender.com/gerente/eliminar_certificado/${form.idCertificado}`,
        { withCredentials: true }
      );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch("https://fumifortebe.onrender.com/gerente/crear_certificado", {
        method: "POST",
        credentials: "include",
        headers: {
          "Content-Type": "application/json",
